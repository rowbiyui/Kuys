          ...
          <tbody>
            @forelse($users as $user)
              <tr class="border-b transition duration-300">
                ...
                <td class="px-6 py-4">
                  <a href="{{ $user->github_link }}" target="_blank" rel="noopener" class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 hover:scale-105 shadow-md transition">
                    View
                  </a>
                </td>
              </tr>
